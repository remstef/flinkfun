...
object CT2Test {
  ...
  def main(args: Array[String]) {
    ...
    println(CT2Full("a", "a", n11 = 1, n1dot = 2, ndot1 = 3, n = 10, srcid = Some("mydoc")).prettyPrint())
    println(CT2Full("a", "a", n11 = 1, n1dot = 2, ndot1 = 3, n = 10, srcid = Some(1234)).prettyPrint())
    println(CT2Full("a", "a", n11 = 1, n1dot = 2, ndot1 = 3, n = 10).prettyPrint())
