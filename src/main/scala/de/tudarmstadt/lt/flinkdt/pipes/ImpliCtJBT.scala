...
object ImpliCtJBT extends App {
  ...
  def exec_pipeline(flip:Boolean, reread_checkpointed_data: Boolean): DataSet[CT2red[String,String]] = {
    ...
    val n11 = ct_raw
      .groupBy("a","b")
      .sum("n11")
      .checkpointed(DSTaskConfig.out_accumulated_AB, _.toString, CtFromString[CT2red[String,String], String,String](_), DSTaskConfig.jobname("(1) N11Sum"), reread_checkpointed_data)
    ...
    val n = n11
      ...
      .checkpointed(DSTaskConfig.out_accumulated_N, _.toString, CtFromString[CT2ext[String,String], String,String](_), DSTaskConfig.jobname("(2) NSum"), reread_checkpointed_data)
    ...
    val n1dot = n11
      ...
      .checkpointed(DSTaskConfig.out_accumulated_A + suffix, _.toString, CtFromString[CT2ext[String,String], String,String](_), DSTaskConfig.jobname("(3) [N1dotSum]" + suffix), reread_checkpointed_data)
    ...
    val ndot1 = n11
      ...
      .checkpointed(DSTaskConfig.out_accumulated_B + suffix, _.toString, CtFromString[CT2ext[String,String], String,String](_), DSTaskConfig.jobname("(4) [Ndot1Sum]" + suffix), reread_checkpointed_data)
    ...
    val joined_n1dot = n11
      ...
      .checkpointed(DSTaskConfig.out_accumulated_CT + "_join_n1dot" + suffix, _.toString, CtFromString[CT2ext[String,String], String,String](_), DSTaskConfig.jobname("(5.1) [Join N1dot]" + suffix), reread_checkpointed_data)
    ...
    val joined = joined_n1dot
      ...
      .checkpointed(DSTaskConfig.out_accumulated_CT + "_join_n1dot_ndot1" + suffix, _.toString, CtFromString[CT2ext[String,String], String,String](_), DSTaskConfig.jobname("(5.2) [Join N1dot, Ndot1]" + suffix), reread_checkpointed_data)
    ...
    val ct2_complete = joined
      ...
      .map(_._1)
      .checkpointed(DSTaskConfig.out_accumulated_CT + suffix, _.toString, CtFromString[CT2ext[String,String], String,String](_), DSTaskConfig.jobname("(6) [Join N, Prune by LMI]" + suffix), reread_checkpointed_data)
    ...
    val ct_dt = ct2_complete
      ...
      .checkpointed(DSTaskConfig.out_dt + suffix + "__rawtemp", _.toString, CtFromString[CT2red[String,String], String,String](_), DSTaskConfig.jobname("(8) [DT: Join]" + suffix), reread_checkpointed_data)
      .groupBy("a", "b")
      .sum("n11")
      .checkpointed(DSTaskConfig.out_dt + suffix, _.toString, CtFromString[CT2red[String,String], String,String](_), DSTaskConfig.jobname("(9) [DT: Sum]" + suffix), reread_checkpointed_data)

    val ct_dt_fsort = ct_dt
      .applyTask(FilterSortDT[CT2red[String, String], String, String](_.n11))
      .checkpointed(DSTaskConfig.out_dt_sorted + suffix, _.toString, CtFromString[CT2red[String,String], String,String](_), DSTaskConfig.jobname("10 [DT: Filter, Sort]" + suffix), reread_checkpointed_data)
    // END: dt
