...
object ComputeDT {
  ...
  def fromCT2[T1 : ClassTag : TypeInformation, T2 : ClassTag : TypeInformation]() = new ComputeDT__CT2[T1,T2]()

}

class ComputeDT__CT2[T1 : ClassTag : TypeInformation, T2 : ClassTag : TypeInformation] extends DSTask[CT2[T1,T2], CT2Min[T1,T1]] {
