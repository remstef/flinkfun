...
object TextToCT2 {
  ...
  def ngrams(text:String, n:Int=5): TraversableOnce[CT2[String,String]] = {
    val nh = n/2;
  ...
  def ngram_patterns(text:String, n:Int=5, num_wildcards:Int=2): TraversableOnce[CT2[String,String]] = {
  ...
  def kSkipNgram(text:String, n:Int=3, k:Int=2): TraversableOnce[CT2[String,String]] = {
  ...
  def kWildcardNgramPatterns(text:String, n:Int=3, k:Int=2): TraversableOnce[CT2[String,String]] = {
